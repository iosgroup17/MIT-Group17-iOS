//
//  SchForTodayImageTableViewCell.swift
//  HandleApp
//
...
class SchForTodayImageTableViewCell: UITableViewCell {
    ...
    func configure(with post: Post) {
        ...
        if let scheduledDate = post.scheduledAt {
            dateLabel.text = SchForTodayImageTableViewCell.dateFormatter.string(from: scheduledDate)
            timeLabel.text = SchForTodayImageTableViewCell.timeFormatter.string(from: scheduledDate)
        } else {
